...
public class HaltestelleController implements Initializable {
    ...
    @FXML
    private StackPane pane_pictureView;
    @FXML
    private VBox vboxRight;

    @FXML
    private Button btn_displayHaltesteig;
    @FXML
    private Button btn_displayAufzug;
    @FXML
    private Button btn_displayEngstelle;
    @FXML
    private Button btn_displayFahrkartenautomat;
    @FXML
    private Button btn_displayFahrradanlage;
    @FXML
    private Button btn_displayGleisquerung;
    @FXML
    private Button btn_displayInformationsstelle;
    @FXML
    private Button btn_displayLeihradanlage;
    @FXML
    private Button btn_displayParkplatz;
    @FXML
    private Button btn_displayRampe;
    @FXML
    private Button btn_displayRolltreppe;
    @FXML
    private Button btn_displayStationsplan;
    @FXML
    private Button btn_displayTaxi;
    @FXML
    private Button btn_displayToilette;
    @FXML
    private Button btn_displayTreppe;
    @FXML
    private Button btn_displayTuer;
    @FXML
    private Button btn_displayVerkaufsstelle;
    @FXML
    private Button btn_displayWeg;
    @FXML
    private Button btn_otherStation;
    @FXML
    ...
    private void createStationViewFooter() {
        ...
        btnOk.setPrefSize(210, 50);
        btnOk.setMinSize(210, 45);
        btnSearchStationByTown.setPrefSize(100, 50);
        btnSearchStationByTown.setMinSize(100, 45);
    ...
    protected void loadObject() {
        if (infoObjectTableView.getSelectionModel().getSelectedItem() != null) {
            objectLoader.loadObject(infoDisplay, infoObjectTableView.getSelectionModel().getSelectedItem().getInfoType());
        }
    }
